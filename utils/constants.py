...
DEFAULT_ENTERPRISE = 'One Assure'
DEFAULT_TRAINING_PLAYLIST_ID = 1
DEFAULT_MARKETING_PLAYLIST_ID = 2
...
# Success messages  ==================================
OTP_MESSAGE = '<#> Your One Time Password for One Assure is %s %s'
...
USER_CREATION_MESSAGE = 'Hi,\nYour account with One Assure has been created successfully with phone no %s.\n\nRegards\nTeam One Assure' # noqa
USER_CREATED_SUCESS = 'User created successfully!'
USER_PASSWORD_CHANGE = 'Hi,\nYour One Assure account password has been changed successfully.\n\nRegards\nTeam One Assure' # noqa
PASSWORD_REQUIRED = 'Password is required.'
PROMO_MESSAGE = 'Hi %s, Welcome to One Assure, download our app and become super advisor https://tinyurl.com/y2ux5cdj .' # noqa
...
ACCOUNT_DISABLED = 'Account is unactive. Please contact One Assure for reactivation' # noqa
...
FAILED_APPLICATION_CREATION = 'Failed to add contact. Please contact One Assure'
